...
import { D3FontWeight, D3MarkOrientation, D3MarkType, D3SymbolType, Facet, MarkEncoding, MarkEncodingKey, MarkEncodings, MarkType } from "../model";
import { D3MarkSpec } from "../spec";
import { D3GraphSceneBuilder } from "./builder";

export class MarkBuilder {
    public readonly spec: D3MarkSpec
    private _child?: D3GraphSceneBuilder
    private readonly _type: D3MarkType

    public constructor(type: D3MarkType) {
        this._type = type;
        this.spec = new D3MarkSpec(type);
    }
    ...
    public encode(
        ...
        encoding: undefined | MarkEncoding<D3MarkOrientation>,
    ): MarkBuilder
    public encode(
    ...
    public encode(
        ...
        encoding: undefined | MarkEncoding<D3SymbolType | string>,
    ): MarkBuilder
    public encode(
    ...
    public encode(
        ...
        encoding: undefined | MarkEncoding<D3FontWeight>,
    ): MarkBuilder
    public encode(
    ...
    // ): MarkBuilder
    public encode(key: MarkEncodingKey, encoding: MarkEncoding<unknown>): MarkBuilder
    ...
    public facet(facet: Facet | undefined): MarkBuilder {
        if (facet !== undefined && this._type !== MarkType.Group) {
    ...
    public child(callback: (b: D3GraphSceneBuilder) => void): MarkBuilder {
        if (this.spec.child) {
            console.warn(`MarkBuilder may only have one child at a time`)
        }


        this._child = new D3GraphSceneBuilder()
