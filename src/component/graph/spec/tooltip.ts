import { D3TooltipType, TooltipSpec } from "../model"
...
export class D3TooltipSpec implements TooltipSpec {
    ...
    private _valueSchema: Record<string, (value: string) => React.ReactNode>
    ...
    set valueSchema(value: Record<string, (value: string) => React.ReactNode>) {
        this._valueSchema = {
            ...this._valueSchema,
            ...value,
        }
